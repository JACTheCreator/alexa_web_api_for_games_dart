...
abstract class DefaultMessageProvider implements MessageProvider {
  ...
  @JS('DefaultMessageProvider.receive')
  @override
  void receive(MessageCallback callback);

  @JS('DefaultMessageProvider.send')
  @override
  ...
  @JS('DefaultMessageProvider.DEFAULT_RATELIMIT_MAX_REQUEST_PER_SEC')
  external List<String> get defaultRatelimitMaxRequestPerSec;

  @JS('DefaultMessageProvider.HEADER_RATELIMIT_LIMIT')
  external List<String> get headerRatelimitLimit;

  @JS('DefaultMessageProvider.HEADER_RATELIMIT_NEXTREQUEST')
  external List<String> get headerRatelimitNextrequest;

  @JS('DefaultMessageProvider.HEADER_RATELIMIT_REMAINING')
  external List<String> get headerRatelimitRemaining;

  @JS('DefaultMessageProvider.HEADER_RATELIMIT_RESET')
